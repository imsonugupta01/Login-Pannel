...
class ShowData extends StatefulWidget {
  const ShowData({super.key,required this.gmail});
  final String gmail;
...
class _ShowDataState extends State<ShowData> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder(
        stream: FirebaseFirestore.instance.collection("AllClohtes").snapshots(),
                          ...
                          onPressed: () {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                               ...
                               //  MyHomePage(title: "${snapshot.data!.docs[index]["Product Name"]}",
                               //
                               // // StudentProfile();
                               //  ),
                                ProductPage(),
